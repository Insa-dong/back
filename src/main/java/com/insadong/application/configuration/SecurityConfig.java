...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		return http
				...
				.antMatchers("/insa/v1/studyInfoList/**", "/insa/v1/PetiteStudyInfo/**", "/insa/v1/studyInfo/**", "/insa/v1/studyInsert", "/insa/v1/studyInfo", "/insa/v1/trainingTitleList", "/insa/v1/trainingList/**", "/insa/v1/training/**", "/insa/v1/myScheduleList", "/insa/v1/myPagingScheduleList", "/insa/v1/myScheduleUpdate", "/insa/v1/mySchedule/**").hasRole("ADMIN")
				.antMatchers("/abs/abs-admin/**").hasRole("ADMIN")
				.antMatchers("/off/adminOff/**" ).hasRole("ADMIN")
				.antMatchers("/abs","/off/**").permitAll()
