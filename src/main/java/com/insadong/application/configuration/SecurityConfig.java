...
//				.antMatchers("/insa/v1/student/registration").hasRole("ADMIN")
//				.antMatchers("/training", "/training/**", "/study", "/study/registration", "/studyInfo/**").hasRole("ADMIN")
//				.antMatchers("/cal").hasRole("MEMBER")
//				.antMatchers("/empTeacher", "/empTeacher/**").hasRole("TEACHER")
//				.antMatchers("/off/adminOff").hasRole("ADMIN")
//				.antMatchers("/off/teamOff").hasRole("LEADER")
//				.antMatchers("/abs/adminAbs").hasRole("ADMIN")
				.and()
				.cors()
				.and()
